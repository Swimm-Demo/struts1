...
flowchart TD
    node1["User clicks cancel"] --> node2["Locating the Handler Method"]
    click node1 openCode "extras/src/main/java/org/apache/struts/actions/ActionDispatcher.java:282:284"
    
    node2 --> node3{"Is a cancellation handler available?"}
    click node3 openCode "extras/src/main/java/org/apache/struts/actions/ActionDispatcher.java:290:292"
    ...
    node4 --> node6["User sees cancellation confirmation"]
...
%%     
%%     node2 --> node3{"Is a cancellation handler available?"}
%%     click node3 openCode "<SwmPath>[extras/…/actions/ActionDispatcher.java](extras/src/main/java/org/apache/struts/actions/ActionDispatcher.java)</SwmPath>:290:292"
%%     node3 -->|"Yes"| node4["Dispatching the Cancelled Handler"]
%%     
%%     node3 -->|"No"| node5["No action taken"]
